...
class PitchClassSequenceTest(unittest.TestCase):
    def test_init(self):
        test_set = PitchClassSequence([0])
        self.assertIsInstance(test_set, PitchClassSequence)
    ...
    def test_set_pcs(self):
        test_set = PitchClassSequence([0])
        test_set.set_pcs([0, 1, 0])
        self.assertEqual(test_set.pcs, [0, 1, 0])

    def test_private_transposed(self):
        test_set = PitchClassSequence([0, 1, 0])
        returned_0 = test_set._transposed(1)
        self.assertIsInstance(returned_0, list)
    ...
    def test_transpose(self):
        test_set = PitchClassSequence([0, 1, 2])
        test_set.transpose(1)
        self.assertEqual(test_set.pcs, [1, 2, 3])
        test_set.transpose(10)
        self.assertEqual(test_set.pcs, [11, 0, 1])
    ...
    def test_invert(self):
        test_set = PitchClassSequence([0, 1, 0])
        test_set.invert(0)
        self.assertEqual(test_set.pcs, [0, 11, 0])
        test_set.invert(10)
        self.assertEqual(test_set.pcs, [10, 11, 10])

    def test_private_m_transformed(self):
        test_set = PitchClassSequence([0, 2, 0])
        returned_0 = test_set._m_transformed(5)
        self.assertIsInstance(returned_0, list)
    ...
    def test_m_transformed(self):
        test_set = PitchClassSequence([0, 3, 0])
        returned_0 = test_set.m_transformed(5)
        self.assertIsInstance(returned_0, PitchClassSequence)
    ...
    def test_m_transform(self):
        test_set = PitchClassSequence([0, 4, 0])
        test_set.m_transform(5)
        self.assertEqual(test_set.pcs, [0, 8, 0])
        test_set.m_transform(11)
        self.assertEqual(test_set.pcs, [0, 4, 0])

    def test_pc_inventory(self):
        test_set = PitchClassSequence([0, 1, 2, 0])
        returned_0 = test_set.pc_inventory()
        self.assertIsInstance(returned_0, PitchClassSet)
